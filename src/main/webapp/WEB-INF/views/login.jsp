    ...
    <div class="wrapper">
        ...
        <div class="authorization">
            <div class="authorization_form">
                ...
                class="authorization_link marker" href="<%=request.getContextPath()%>/newAccount">アカウント作成</a>
            </div>
                <div class="authorization_navi">
                <label class="authorization_text">パスワードをお忘れの方</label> <a 
                class="authorization_link marker" href="<%=request.getContextPath()%>/passwordReset">パスワードリセット</a>
            </div>
        </div>
        <footer>
