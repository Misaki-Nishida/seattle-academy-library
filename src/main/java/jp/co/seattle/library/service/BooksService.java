...
public class BooksService {
	...
	public int registBook(BookDetailsInfo bookInfo) {
		...
		String sql = "Insert into books (title, author, publisher, publishdate, thumbnailname, thumbnailurl, isbn, description, reg_date, upd_date) values (?,?,?,?,?,?,?,?,now(),now()) RETURNING id";
